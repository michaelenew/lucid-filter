...
- **AUD-10** (multivariate-statfilter 0057–0059): the attribution grid's remaining opens. The
  ...
  the rate ladder's interior is a budget (monotone in code length at 2/3/5/9 rungs, 0060) whose rungs buy state transients the acceptance windows do not score;
